//@pilet v:2(webpackChunkpr_validator,{})
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var _mui_icons_material_Rule__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @mui/icons-material/Rule */ "./node_modules/@mui/icons-material/Rule.js");
/* harmony import */ var _App__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./App */ "./src/App.tsx");



function setup(app) {
  var connect = app.makeState(app);
  var Module = connect(function (_ref) {
    var state = _ref.state,
        actions = _ref.actions;
    return app.withState(_App__WEBPACK_IMPORTED_MODULE_1__["default"], {
      app: app,
      state: state,
      actions: actions
    });
  });
  app.showNotification("Hello from ".concat(app.meta.name, " Pilet!"), {
    autoClose: 2000
  });
  app.registerExtension(app.meta["link"], Module);
  app.registerExtension("".concat(app.meta["link"], "/icon"), function () {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_icons_material_Rule__WEBPACK_IMPORTED_MODULE_2__["default"], null);
  });
}
})();
